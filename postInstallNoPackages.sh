...
# this script assume you've installed Ubuntu 14.04.2 LTS i386from Robuntu iso image (comming soon on this repo)
# it also assume that user "ensta" with password "toor" has been created during installation (with an existing /home/ensta)
